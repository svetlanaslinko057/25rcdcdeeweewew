    ...
    <div className="space-y-6" data-testid="review-queue">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          {/* Submission Detail */}
          {selectedSubmission && (
            <div className="border border-white/10 p-6 bg-white/[0.02] sticky top-20">
              <h3 className="text-lg font-semibold mb-4">
                {selectedSubmission.work_unit_title || `Submission #${selectedSubmission.submission_id.slice(-6)}`}
              </h3>

              {/* Developer Info */}
              <div className="flex items-center gap-3 p-3 bg-white/5 mb-4">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-emerald-500 text-white p-3 font-medium flex items-center justify-center gap-2 hover:bg-emerald-600 disabled:opacity-50 transition-all"
                >
                ...
                <button
                  ...
                  disabled={actionLoading}
                  className="flex-1 bg-amber-500 text-black p-3 font-medium flex items-center justify-center gap-2 hover:bg-amber-600 disabled:opacity-50 transition-all"
                >
