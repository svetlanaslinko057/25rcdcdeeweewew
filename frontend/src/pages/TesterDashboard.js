                ...
                <div className="space-y-3">
                  {pendingTasks.map((task) => (
                    <div
                      ...
                      className="group border border-white/10 p-5 hover:border-white/20 hover:bg-white/[0.02] transition-all"
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div>
                          <div className="flex items-center gap-3">
                            ...
                            <span className={`px-2 py-0.5 text-xs border ${getStatusBadge(task.status)}`}>
                      ...
                      <div className="mt-4 flex items-center gap-3">
                        <button className="px-3 py-1.5 bg-emerald-500 text-white text-sm font-medium hover:bg-emerald-600 transition-all flex items-center gap-2">
                          <CheckCircle2 className="w-4 h-4" />
                          Pass
                        </button>
                        <button className="px-3 py-1.5 bg-red-500 text-white text-sm font-medium hover:bg-red-600 transition-all flex items-center gap-2">
                          <XCircle className="w-4 h-4" />
                          Fail
                        </button>
                        <button className="px-3 py-1.5 border border-white/20 text-sm hover:bg-white/5 transition-all flex items-center gap-2">
