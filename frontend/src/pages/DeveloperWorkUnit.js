        ...
        <div className="space-y-8">
          ...
          {canStart && (
            <button
              ...
              disabled={submitting}
              className="w-full bg-white text-black p-4 font-semibold flex items-center justify-center gap-2 hover:bg-white/90 disabled:opacity-50 transition-all"
          ...
          <div className="border border-white/10 p-5">
            ...
            {canLog && (
              <form onSubmit={handleLogWork} className="mb-6 p-4 bg-white/[0.02] border border-white/10">
                ...
                <button
                  ...
                  className="bg-white/10 text-white px-4 py-2 text-sm font-medium hover:bg-white/20 disabled:opacity-50 transition-all flex items-center gap-2"
            ...
            {workLogs.length === 0 ? (
              ...
              <div className="space-y-3">
                {workLogs.map((log, i) => (
                  <div key={log.log_id || i} className="flex items-start gap-4 p-3 bg-white/[0.02]">
                    <div className="w-12 h-12 bg-white/10 flex items-center justify-center text-lg font-bold">
                      {log.hours}h
                    </div>
            ...
            <div className="border border-emerald-500/30 bg-emerald-500/5 p-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-emerald-500 text-white p-3 font-semibold flex items-center justify-center gap-2 hover:bg-emerald-600 disabled:opacity-50 transition-all"
          ...
          {/* Submitted State */}
          {isSubmitted && (
            <div className="border border-purple-500/30 bg-purple-500/5 p-5 text-center">
