            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button 
                  ...
                  className="bg-[#0A0A0A] text-white px-8 py-4 text-[15px] font-medium rounded-full hover:bg-[#0A0A0A]/90 transition-colors inline-flex items-center justify-center gap-2"
                  data-testid="client-path-btn"
                >
                ...
                <button 
                  ...
                  className="px-8 py-4 text-[15px] font-medium border border-[#0A0A0A]/15 rounded-full hover:border-[#0A0A0A]/30 hover:bg-[#0A0A0A]/5 transition-all inline-flex items-center justify-center gap-2"
                  data-testid="builder-path-btn"
                >
